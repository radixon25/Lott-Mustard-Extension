...
full_Wls <- summary(lm_robust(lmur ~ shalll + aovio + rpcpi + rpcim + rpcui  + rpcrpo + density + ppwm1019 + ppwm2029 + ppwm3039 + ppwm4049 + ppwm5064 + ppwm65o + ppbm1019 + ppbm2029 + ppbm3039 + ppbm4049 + ppbm5064 + ppbm65o + ppwf1019 + ppwf2029 + ppwf3039 + ppwf4049 + ppwf5064 + ppwf65o + ppbf1019 + ppbf2029 + ppbf3039 + ppbf4049 + ppbf5064 + ppbf65o + ppnm1019 + ppnm2029 + ppnm3039 + ppnm4049 + ppnm5064 + ppnm65o + ppnf1019 + ppnf2029 + ppnf3039 + ppnf4049 + ppnf5064 + ppnf65o +yr78 + yr79 + yr80 + yr81 + yr82 + yr83 + yr84 + yr85 + yr86 + yr87 + yr88 + yr89 + yr90 + yr91 + yr92+ popstate, data = state_data, weight = popstate, fixed_effects = ~ stnumber, clusters = fipsstat, se_type = "stata"))
full_Wls

select_dep <- c('lmur', 'lvio','laga', 'lpro','laut')


#Table 8b Don: Dummy Regression w/ state trend
lmur_full <- lm_robust(lmur ~ shalll + aovio + rpcpi + rpcim + rpcui  + rpcrpo + density + ppwm1019 + ppwm2029 + ppwm3039 + ppwm4049 + ppwm5064 + ppwm65o + ppbm1019 + ppbm2029 + ppbm3039 + ppbm4049 + ppbm5064 + ppbm65o + ppwf1019 + ppwf2029 + ppwf3039 + ppwf4049 + ppwf5064 + ppwf65o + ppbf1019 + ppbf2029 + ppbf3039 + ppbf4049 + ppbf5064 + ppbf65o + ppnm1019 + ppnm2029 + ppnm3039 + ppnm4049 + ppnm5064 + ppnm65o + ppnf1019 + ppnf2029 + ppnf3039 + ppnf4049 + ppnf5064 + ppnf65o +yr78 + yr79 + yr80 + yr81 + yr82 + yr83 + yr84 + yr85 + yr86 + yr87 + yr88 + yr89 + yr90 + yr91 + yr92+ trndAK+trndAL+trndAZ+trndAR+trndCA+trndCO+trndCT +  popstate , data = state_data,clusters = fipsstat, weight = popstate, fixed_effects =  stnumber, se_type = "stata")
laga_full <-lm_robust(laga ~ shalll + aovio + rpcpi + rpcim + rpcui  + rpcrpo + density + ppwm1019 + ppwm2029 + ppwm3039 + ppwm4049 + ppwm5064 + ppwm65o + ppbm1019 + ppbm2029 + ppbm3039 + ppbm4049 + ppbm5064 + ppbm65o + ppwf1019 + ppwf2029 + ppwf3039 + ppwf4049 + ppwf5064 + ppwf65o + ppbf1019 + ppbf2029 + ppbf3039 + ppbf4049 + ppbf5064 + ppbf65o + ppnm1019 + ppnm2029 + ppnm3039 + ppnm4049 + ppnm5064 + ppnm65o + ppnf1019 + ppnf2029 + ppnf3039 + ppnf4049 + ppnf5064 + ppnf65o +yr78 + yr79 + yr80 + yr81 + yr82 + yr83 + yr84 + yr85 + yr86 + yr87 + yr88 + yr89 + yr90 + yr91 + yr92+ trndAK+trndAL+trndAZ+trndAR+trndCA+trndCO+trndCT +  popstate , data = state_data,clusters = fipsstat, weight = popstate, fixed_effects =  stnumber, se_type = "stata")
lpro_full <- lm_robust(lpro ~ shalll + aovio + rpcpi + rpcim + rpcui  + rpcrpo + density + ppwm1019 + ppwm2029 + ppwm3039 + ppwm4049 + ppwm5064 + ppwm65o + ppbm1019 + ppbm2029 + ppbm3039 + ppbm4049 + ppbm5064 + ppbm65o + ppwf1019 + ppwf2029 + ppwf3039 + ppwf4049 + ppwf5064 + ppwf65o + ppbf1019 + ppbf2029 + ppbf3039 + ppbf4049 + ppbf5064 + ppbf65o + ppnm1019 + ppnm2029 + ppnm3039 + ppnm4049 + ppnm5064 + ppnm65o + ppnf1019 + ppnf2029 + ppnf3039 + ppnf4049 + ppnf5064 + ppnf65o +yr78 + yr79 + yr80 + yr81 + yr82 + yr83 + yr84 + yr85 + yr86 + yr87 + yr88 + yr89 + yr90 + yr91 + yr92+ trndAK+trndAL+trndAZ+trndAR+trndCA+trndCO+trndCT +  popstate , data = state_data,clusters = fipsstat, weight = popstate, fixed_effects =  stnumber, se_type = "stata")
lvio_full <- lm_robust(lvio ~ shalll + aovio + rpcpi + rpcim + rpcui  + rpcrpo + density + ppwm1019 + ppwm2029 + ppwm3039 + ppwm4049 + ppwm5064 + ppwm65o + ppbm1019 + ppbm2029 + ppbm3039 + ppbm4049 + ppbm5064 + ppbm65o + ppwf1019 + ppwf2029 + ppwf3039 + ppwf4049 + ppwf5064 + ppwf65o + ppbf1019 + ppbf2029 + ppbf3039 + ppbf4049 + ppbf5064 + ppbf65o + ppnm1019 + ppnm2029 + ppnm3039 + ppnm4049 + ppnm5064 + ppnm65o + ppnf1019 + ppnf2029 + ppnf3039 + ppnf4049 + ppnf5064 + ppnf65o +yr78 + yr79 + yr80 + yr81 + yr82 + yr83 + yr84 + yr85 + yr86 + yr87 + yr88 + yr89 + yr90 + yr91 + yr92+ trndAK+trndAL+trndAZ+trndAR+trndCA+trndCO+trndCT +  popstate , data = state_data,clusters = fipsstat, weight = popstate, fixed_effects =  stnumber, se_type = "stata")
laut_full <- lm_robust(laut ~ shalll + aovio + rpcpi + rpcim + rpcui  + rpcrpo + density + ppwm1019 + ppwm2029 + ppwm3039 + ppwm4049 + ppwm5064 + ppwm65o + ppbm1019 + ppbm2029 + ppbm3039 + ppbm4049 + ppbm5064 + ppbm65o + ppwf1019 + ppwf2029 + ppwf3039 + ppwf4049 + ppwf5064 + ppwf65o + ppbf1019 + ppbf2029 + ppbf3039 + ppbf4049 + ppbf5064 + ppbf65o + ppnm1019 + ppnm2029 + ppnm3039 + ppnm4049 + ppnm5064 + ppnm65o + ppnf1019 + ppnf2029 + ppnf3039 + ppnf4049 + ppnf5064 + ppnf65o +yr78 + yr79 + yr80 + yr81 + yr82 + yr83 + yr84 + yr85 + yr86 + yr87 + yr88 + yr89 + yr90 + yr91 + yr92+ trndAK+trndAL+trndAZ+trndAR+trndCA+trndCO+trndCT +  popstate , data = state_data,clusters = fipsstat, weight = popstate, fixed_effects =  stnumber, se_type = "stata")
lmur_full<- starprep(lmur_full)
laga_full <- starprep(laga_full)
lpro_full <- starprep(lpro_full)
lvio_full <- starprep(lvio_full)
laut_full <- starprep(laut_full)
full_wls_table <- stargazer('lmur_full', 'laga_full', 'lpro_full','lvio_full','laut_full', title = 'Weighted OLS w/ Lott and Mustard Controls', align = TRUE)
#Bacon Decomposition
blmur <-bacon( lmur ~ shalll,state_data, id_var = 'state', time_var = 'year')
blmur <- summary(blmur)
blmur <- blmur %>%
  group_by(type) %>%
  add_row(tibble_row(type = 'Bacon TWFE Coefficient', weight = 1,avg_est =  sum(blmur$weight * blmur$avg_est))
          
blvio <-bacon(lvio ~ shalll,state_data, id_var = 'state', time_var = 'year')
blaga <-bacon(laga ~ shalll,state_data, id_var = 'state', time_var = 'year')
blpro <-bacon(lpro ~ shalll,state_data, id_var = 'state', time_var = 'year')
blaut <-bacon(laut ~ shalll,state_data, id_var = 'state', time_var = 'year')
blaut
#TWFE Estimate from bacon decomp



coef_bacon <- sum(bacon_reg$estimate * bacon_reg$weight)
...
grouped_treatment <- bacon_reg %>%
  group_by(type)%>%
  summarize(group_TE = sum(weighted_estimate))
grouped_treatment <- grouped_treatment%>%
  add_row(type = 'Bacon Coefficient',group_TE = coef_bacon)
grouped_treatment
# Callaway Sant'anna
